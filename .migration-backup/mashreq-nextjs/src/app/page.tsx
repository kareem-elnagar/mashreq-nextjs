...
import { ArrowRight, Factory, Droplet, ShieldCheck, Battery, Download } from "lucide-react";
    ...
    <div className="flex flex-col w-full relative overflow-hidden bg-slate-50/50">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center overflow-hidden rounded-b-[4rem] shadow-2xl bg-[#1e4b8f]">
        <div className="absolute inset-0 z-0">
          <img
            src="/Material/Copy of 20260116_141917.jpg"
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  download
                  className="bg-accent/20 backdrop-blur-md text-white border border-white/30 px-6 py-4 rounded-2xl font-bold text-base hover:bg-accent/40 transition-all flex items-center group"
                >
