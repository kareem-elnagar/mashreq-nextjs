...
import { ArrowRight, Droplet, Zap, Layers, ShieldAlert, Download } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            <div className="flex gap-3">
              <a
                ...
                download
                className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-5 py-3 rounded-2xl font-bold text-sm hover:bg-white/20 transition-all flex items-center group shadow-lg"
              >
