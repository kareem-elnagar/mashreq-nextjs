...
import { ArrowRight, MapPin, Calendar, Activity, Download } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                download
                className="bg-primary/5 text-primary border border-primary/10 px-5 py-3 rounded-2xl font-bold text-sm hover:bg-primary/10 transition-all flex items-center group"
              >
